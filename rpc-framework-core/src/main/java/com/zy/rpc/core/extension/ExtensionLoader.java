 ...
 * 参考：<a href="https://blog.csdn.net/qq_43509535/article/details/122539838/">自定义 spi</a>
 * <p>
...
public class ExtensionLoader<T> {
    ...
    /**
     * 存储接口实现类的实例，key - impClass，val - impClass实例对象
     */
    ...
    /**
     * 缓存的实例 key - name，val - impClass实例对象
     */
    ...
    /**
     * 对应文件内的：key - name，value - implClass
     */
