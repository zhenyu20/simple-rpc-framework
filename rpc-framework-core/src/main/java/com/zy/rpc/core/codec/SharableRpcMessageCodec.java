...
import com.zy.rpc.core.constant.ProtocolConstants;
...
import com.zy.rpc.core.serialization.SerializationFactory;
...
/**
 * 可共享的 Rpc 消息编码解码器，使用此编解码器必须配合 {@link com.zy.rpc.core.codec.RpcFrameDecoder} 进行使用，
 * 以保证得到完整的数据包。
 * <p>
 * 消息协议：
 * <pre>
