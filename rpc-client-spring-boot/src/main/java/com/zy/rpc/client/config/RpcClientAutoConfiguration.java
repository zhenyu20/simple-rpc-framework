package com.zy.rpc.client.config;

import com.zy.rpc.client.proxy.ClientStubProxyFactory;
import com.zy.rpc.client.spring.RpcClientBeanPostProcessor;
import com.zy.rpc.client.spring.RpcClientExitDisposableBean;
import com.zy.rpc.client.transport.RpcClient;
import com.zy.rpc.client.transport.http.HttpRpcClient;
import com.zy.rpc.client.transport.netty.NettyRpcClient;
import com.zy.rpc.client.transport.socket.SocketRpcClient;
import com.zy.rpc.core.discovery.ServiceDiscovery;
import com.zy.rpc.core.discovery.nacos.NacosServiceDiscovery;
import com.zy.rpc.core.discovery.zk.ZookeeperServiceDiscovery;
import com.zy.rpc.core.loadbalance.LoadBalance;
import com.zy.rpc.core.loadbalance.impl.ConsistentHashLoadBalance;
import com.zy.rpc.core.loadbalance.impl.RandomLoadBalance;
import com.zy.rpc.core.loadbalance.impl.RoundRobinLoadBalance;
